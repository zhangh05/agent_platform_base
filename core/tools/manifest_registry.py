...
MANIFESTS: dict[str, CapabilityManifest] = {
    ...
    "device.manage": CapabilityManifest(
        ...
        category="ops",
        display_name="Device Connectivity",
        description="Read-only network device connection probing and command reads.",
        action_class="network",
        risk_level="medium",
        side_effects="read",
        idempotency="unsafe_to_retry",
    ...
    "agent.manage": CapabilityManifest(
        ...
        category="agent",
        display_name="Agent",
        description="List subagent profiles, get results, cancel tasks, and inspect status.",
        action_class="execute",
        risk_level="low",
        side_effects="none",
        idempotency="safe_to_retry",
    ...
    "system.manage": CapabilityManifest(
        ...
        category="system",
        display_name="System",
        description="Diagnostics, health, task, audit, run, session, and review operations.",
        action_class="admin",
        risk_level="medium",
        side_effects="write",
        idempotency="unsafe_to_retry",
