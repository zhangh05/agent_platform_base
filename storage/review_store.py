...
from storage.records import atomic_save_json, read_json_record, workspace_record_dir
...
def append_review_item(workspace_id: str, artifact_id: str, item: dict[str, Any]) -> dict[str, Any]:
    """Append one item to a sidecar, de-duplicating stable source keys."""
    sidecar = load_sidecar(workspace_id, artifact_id) or {}
