...
JOB_TYPES = {"agent_run", "export_report", "knowledge_index", "generic_agent_task", "workflow_run", "network_inspection"}
ENABLED_JOB_TYPES = {"agent_run", "export_report", "knowledge_index", "generic_agent_task", "workflow_run", "network_inspection"}
